# tool_name: extract_video_frames_with_contract_validation
...
@tool
def extract_video_frames_with_contract_validation(video_path: str, output_dir: str = None, frame_rate: int = 1, max_frames: int = None, format: str = 'jpg'):
    """
    从视频中抽取帧，并验证参数契约
