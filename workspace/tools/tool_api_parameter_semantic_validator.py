# tool_name: api_parameter_semantic_validator
...
@tool
def api_parameter_semantic_validator(input_args):
    """
    API参数语义验证与400错误预测性防御工具
    ...
    def repair_parameter_format(parameters, parameter_contract):
        ...
        for param_name, param_def in parameter_contract.items():
            ...
            # 调试：记录检查结果
            repairs_applied.append(f'检查参数 {param_name}: required={required_check}, in_repaired={param_name in repaired}')
